...
public class DriveCommands {
  ...
  private static Translation2d getLinearVelocityFromJoysticks(double x, double y) {
    // Apply deadband
    double linearMagnitude = MathUtil.applyDeadband(Math.hypot(x, y), DRIVER_DEADBAND);
  ...
  public static Command joystickDrive(
    ...
    return Commands.run(
        () -> {
          ...
          double omega = MathUtil.applyDeadband(omegaSupplier.getAsDouble(), DRIVER_DEADBAND);
